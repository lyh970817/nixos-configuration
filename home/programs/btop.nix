...
in
{
  programs.btop = {
    ...
    themes = {
      vt220-amber = ''
        theme[main_bg]="#080705"
        theme[main_fg]="#D99B32"
        theme[title]="#D99B32"
        theme[hi_fg]="#D99B32"
        theme[selected_bg]="#9B6D24"
        theme[selected_fg]="#080705"
        theme[inactive_fg]="#2A2011"
        theme[graph_text]="#BE842A"
        theme[meter_bg]="#0C0A06"
        theme[proc_misc]="#6E501D"
        theme[cpu_box]="#D99B32"
        theme[mem_box]="#BE842A"
        theme[net_box]="#9B6D24"
        theme[proc_box]="#D99B32"
        theme[div_line]="#2A2011"
        theme[temp_start]="#2A2011"
        theme[temp_mid]="#9B6D24"
        theme[temp_end]="#D99B32"
        theme[cpu_start]="#2A2011"
        theme[cpu_mid]="#9B6D24"
        theme[cpu_end]="#D99B32"
        theme[free_start]="#2A2011"
        theme[free_mid]="#6E501D"
        theme[free_end]="#9B6D24"
        theme[cached_start]="#2A2011"
        theme[cached_mid]="#6E501D"
        theme[cached_end]="#BE842A"
        theme[available_start]="#2A2011"
        theme[available_mid]="#9B6D24"
        theme[available_end]="#D99B32"
        theme[used_start]="#6E501D"
        theme[used_mid]="#BE842A"
        theme[used_end]="#D99B32"
        theme[download_start]="#2A2011"
        theme[download_mid]="#9B6D24"
        theme[download_end]="#D99B32"
        theme[upload_start]="#0C0A06"
        theme[upload_mid]="#6E501D"
        theme[upload_end]="#BE842A"
        theme[process_start]="#D99B32"
        theme[process_mid]="#9B6D24"
        theme[process_end]="#2A2011"
      '';
